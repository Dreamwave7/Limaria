                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-5">
                            <div class="section-halfscreen-content">
                                ...
                                <div class="wow-outer heading-3 offset-negative-1">
                                    <h1 class="wow fadeInUp" data-wow-delay=".2s" >
                                        <span class="font-weight-light">Ми надаємо надійні та доступні наукові дослідницькі послуги</span><br>
                                    </h1>
                                </div>

                                <div class="wow-outer p">
                                    <p class="wow fadeInDown" data-wow-delay=".2s">Лабораторні послуги "Лімарія" відзначаються доступною ціною та проводяться в надсучасних приміщеннях, обладнаних передовими автоматизованими системами, що регулярно обслуговуються для забезпечення найвищої якості досліджень.</p>
                                    <!-- </div><a class="button button-primary button-winona wow fadeIn" href="#">Дiзнатись бiльше</a> -->
                                </div>
