...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('css_second/bootstrap.css') }}">
    <link rel="stylesheet" href="{{ asset('css_second/fonts.css') }}">
    <link rel="stylesheet" href="{{ asset('css_second/style.css') }}">
